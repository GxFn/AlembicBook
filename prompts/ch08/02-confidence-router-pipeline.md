...
Visible title at top: "ConfidenceRouter 路由管线"

Purpose:
Show how confidence, evidence, and quality decide where a candidate goes.

Main layout:
- Left: candidate enters with AI confidence, sourceRefs, quality score, duplicate status.
- Center: ConfidenceRouter as a purple decision hub.
- Three outputs: pending, staging, active-ready.
- Add a human review gate before final publish.
- Bottom: audit record documents why the route was chosen.
