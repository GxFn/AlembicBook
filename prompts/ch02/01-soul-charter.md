...
Visible title at top: "SOUL 宪章"

Purpose:
Explain SOUL as the identity constraint behind all engineering decisions.

Main layout:
- Center: a constitution document labeled SOUL.
- Top row: three hard constraints as numbered seals: 安全, 确定性, 隐私.
- Bottom row: five design philosophies as connected cards: 渐进式, 信号驱动, 有机进化, 纵深防御, 诚实边界.
- Side arrows show how the charter influences Gateway, Tool, Memory, and Delivery.
