...
Visible title at top: "Signal · Governance · Guard 数据流"

Purpose:
Show how the organism responds through three cooperating systems.

Main layout:
- Draw three large systems in a triangle: Signal 神经, Governance 消化, Guard 免疫.
- Center: Recipe as the knowledge cell.
- SignalBus routes 12 signal types around the triangle.
- Governance handles lifecycle, redundancy, decay, and proposals.
- Guard checks code and feeds violations / false positives back into signals.
