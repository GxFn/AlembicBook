...
Visible title at top: "衰退评分模型"

Purpose:
Visualize how recipe health decays from multiple weighted signals.

Main layout:
- Left: four input meters: freshness 0.3, usage 0.3, quality 0.2, authority 0.2.
- Center: weighted score calculator from 0 to 100.
- Right: five verdict bands: healthy, watch, decay, severe, dead.
- Bottom: six strategy chips: no_recent_usage, false_positive, symbol_drift, source_ref_stale, superseded, contradiction.
...
Legend / footer:
- 低健康度触发 prescreen、evolution 或 deprecate
