...
Visible title at top: "进化提案流程"

Purpose:
Show how Alembic changes knowledge without letting an Agent silently overwrite truth.

Main layout:
- Left: trigger signals: 衰退, 文件变更, 冗余, 人工请求.
- Center: EvolutionGateway creates proposal cards: update or deprecate.
- Next: EvolutionPolicy assigns risk and observation window.
- Right: ProposalExecutor decides execute, wait, reject, or escalate.
- Bottom: original Recipe remains immutable until a reviewed transition happens.
